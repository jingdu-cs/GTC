...
def batched_matrix_multiply(anchor_rep, non_anchor_shuff, chunk_size):
    """
    Perform batched matrix multiplication to save GPU memory.
    
    Args:
        anchor_rep: Tensor of shape (bsz, dim)
        non_anchor_shuff: Tensor of shape (bsz, dim)
        chunk_size: Size of chunks to split non_anchor_shuff into
    
    Returns:
        logits: Tensor of shape (bsz, bsz)
    """
