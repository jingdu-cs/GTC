# construct 3 interaction graphs: user-item id, user-item visual, user-item textual, and then concate representations of all modalities for prediction
# following is code for this implementation in file: MMR_SYMILE.py
# coding: utf-8
#
